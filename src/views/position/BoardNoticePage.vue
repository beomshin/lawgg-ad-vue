...
import EnrollBoardRequest from "@/dto/board/EnrollBoardRequest";
...
export default {
  ...
  methods: {
    ...
    enroll() {
      ...
      const param = new EnrollBoardRequest(this.writer, this.title, this.content, this.files, this.type)
      service.enrollBoard(param).then(res => {
